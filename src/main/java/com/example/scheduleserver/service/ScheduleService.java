...
public class ScheduleService {
    ...
    public ScheduleResponseDto addSchedule(String title, String contents, HttpSession session) {
        ...
        return new ScheduleResponseDto(savedSchedule.getUser().getName(), savedSchedule.getTitle(), savedSchedule.getContents(), savedSchedule.getCreatedDate(), savedSchedule.getModifiedDate());
    }
